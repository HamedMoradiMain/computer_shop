...
class Database:
    def __init__(self,db):
        # setup connection and create table
...
db.insert("Asus Mohbo","Mike Henry","Microcenter","360")
db.insert("500w PSU","Karen Johnson","Newgg","80")
db.insert("2GB DDR4 Ram","Karen Johnson","Newgg","70")
db.insert("24 inch Samsung Monitor","Sam Smith","Best Buy","180")
db.insert("NVIDIA RTX 2080","Albert Kingston","Newgg","679")
db.insert("600w Corsair PSU","Karen Johnson","Newgg","130")